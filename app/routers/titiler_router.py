...
async def cog_bounds(
    ...
    url = f"s3://covid-wb/merged_tifs/{url}.tif"
...
@router.get(r"/{url}/tiles/{z}/{x}/{y}", **params)
@router.get(r"/{url}/tiles/{z}/{x}/{y}\.{format}", **params)
@router.get(r"/{url}/tiles/{z}/{x}/{y}@{scale}x", **params)
@router.get(r"/{url}/tiles/{z}/{x}/{y}@{scale}x\.{format}", **params)
@router.get(r"/{url}/tiles/{TileMatrixSetId}/{z}/{x}/{y}", **params)
@router.get(r"/{url}/tiles/{TileMatrixSetId}/{z}/{x}/{y}\.{format}", **params)
@router.get(r"/{url}/tiles/{TileMatrixSetId}/{z}/{x}/{y}@{scale}x", **params)
@router.get(r"/{url}/tiles/{TileMatrixSetId}/{z}/{x}/{y}@{scale}x\.{format}", **params)
async def cog_tile(
...
@router.get(r"/{url}/preview", **params)
@router.get(r"/{url}/preview\.{format}", **params)
...
@router.get(r"/{url}/crop/{minx},{miny},{maxx},{maxy}\.{format}", **params)
async def cog_part(
...
@router.get(
    "/{url}/{TileMatrixSetId}/tilejson.json",
    response_model=TileJSON,
    responses={200: {"description": "Return a tilejson"}},
    response_model_exclude_none=True,
)
...
@router.get("/{url}/WMTSCapabilities.xml", response_class=XMLResponse, tags=["OGC"])
@router.get(
    "/{url}/{TileMatrixSetId}/WMTSCapabilities.xml",
